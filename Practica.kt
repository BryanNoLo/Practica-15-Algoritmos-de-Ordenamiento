...
//Insetion sort
fun insertionSoft(arr: IntArray){
...
fun main(args: Array<String>) {
    ...
    val orderedList = (1..10000).toList().toIntArray()

    println("Tiempos de ejecucion comparativa")

    val bubbleSmall = measureSortTime(::bubbleSort, smallList)
    val insertionSmall = measureSortTime(::insertionSoft, smallList)
    ...
    println("Seletion sort: $selectionSmall")
}